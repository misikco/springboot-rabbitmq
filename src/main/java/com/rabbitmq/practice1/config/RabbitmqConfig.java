package com.rabbitmq.practice1.config;

import com.rabbitmq.practice1.rabbitmq.SimpleListener;
import com.rabbitmq.practice1.rabbitmq.UserOrderListener;
...
public class RabbitmqConfig {
    ...
    @Bean
    public UserOrderListener getUserOrderListener(){
        return new UserOrderListener();
    }
    ...
    public CachingConnectionFactory getConnectionFactory(){
        ...
        connectionFactory.setAddresses(env.getProperty("spring.rabbitmq.host",String.class)+":"+env.getProperty("spring.rabbitmq.port",String.class));
        connectionFactory.setUsername(env.getProperty("spring.rabbitmq.username",String.class));
        connectionFactory.setPassword(env.getProperty("spring.rabbitmq.password",String.class));
        connectionFactory.setVirtualHost(env.getProperty("spring.rabbitmq.virtual-host",String.class));
