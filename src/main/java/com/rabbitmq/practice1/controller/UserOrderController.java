...
import com.rabbitmq.practice1.dto.LogDto;
import com.rabbitmq.practice1.dto.UserOrderDto;
...
import com.rabbitmq.practice1.service.CommonLogService;
...
public class UserOrderController {
    ...
    public BaseResponse pushUserOrderV3(@RequestBody UserOrderDto dto){
        ...
        try {
            ...
            final Long ttl=15000L; //可以用随机数替代
